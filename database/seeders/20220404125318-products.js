    ...
    return queryInterface.bulkInsert('products', [
      {
        ...
        type: 'Plugins',
        description:
          'LOTUS is an analog delay / pitch shifter with hundreds of unique capabilities. If you’re trying to make your melodies more unique, you need this plugin.',
        cost: '120',
        created_at: new Date(),
        updated_at: new Date()
      },
      ...
      },
      {
        ...
        type: 'Bundles',
        description:
          'Basses can be the make or break for any track, and typically glue together the vibe of your mix and track as a whole.',
        cost: '25',
        created_at: new Date(),
        updated_at: new Date()
      },
      {
        ...
        type: 'Bundles',
        description:
          'Choose 3 melody packs from the list below (each pack includes 20 melody loops with stems and MIDI)',
        cost: '40',
        created_at: new Date(),
        updated_at: new Date()
      },
      ...
      },
      {
        ...
        type: 'Drum Kits',
        description:
          'Just look at huge artists like Drake, Migos, and Travis Scott who are constantly selling out stadiums and dominating top charts everywhere.',
        cost: '25',
        created_at: new Date(),
        updated_at: new Date()
      },
      ...
      },
      {
        ...
        type: 'Melodies',
        description:
          'With some of the biggest producers like Murda Beatz and Mike Will creating billboard hits one after the other, it’s clear that trap music is one of the biggest sub-genres in modern hip-hop.',
        cost: '56',
        created_at: new Date(),
        updated_at: new Date()
      },
      ...
      },
      {
        ...
        type: 'Melodies',
        description:
          'That’s why we put together this collection, with a vast library of different style samples for you to build off of, your beats are guaranteed to stand out!',
        cost: '80',
        created_at: new Date(),
        updated_at: new Date()
      },
      {
        ...
        type: 'MIDI',
        description:
          'Finding motivation to create memorable melodies and enchanting chords can be tough for any producer!',
        cost: 'free',
        created_at: new Date(),
        updated_at: new Date()
      },
      ...
      },
      {
        ...
        type: 'One-Shots',
        description:
          'This HUGE bank of melodic vocal loops and one shots was inspired by legendary artists like Flume, Daft Punk, Skrillex, Diplo, DJ Snake and Porter Robinson.',
        cost: '17',
        created_at: new Date(),
        updated_at: new Date()
      },
      {
        ...
        type: 'One-Shots',
        description:
          'Finding the right kick for your track has never been easier.',
        cost: '15',
        created_at: new Date(),
        updated_at: new Date()
      },
      ...
      },
      {
        ...
        type: 'Serum',
        description:
          'Vibes for Serum includes 90 lush pads, warm keys, nostalgic plucks and more to take your production in a whole new direction.',
        cost: '256',
        created_at: new Date(),
        updated_at: new Date()
      }
